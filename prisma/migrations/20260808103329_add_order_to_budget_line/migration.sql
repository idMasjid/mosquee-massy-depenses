...
INSERT INTO "new_BudgetLine" ("budgetedAmountHTCents", "createdAt", "id", "isActive", "notes", "productTitle", "projectId", "rubrique", "updatedAt") SELECT "budgetedAmountHTCents", "createdAt", "id", "isActive", "notes", "productTitle", "projectId", "rubrique", "updatedAt" FROM "BudgetLine";
